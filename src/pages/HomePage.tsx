                            ...
                            <div className="landing-section-cards-row">
                                <div className="landing-section-card">
                                    ...
                                    <div className="landing-section-card-description">
                                        ...
                                        later (1946) the Blood Transfusion Service was formed. In 1996 the National
                                        Blood
                                        Service was formed to collect and provide blood supplies for all the hospitals
                                        in
                                        Sri Lanka.
                                    </div>
                                </div>
                                <div className="landing-section-card">
                                    ...
                                    <div className="landing-section-card-description">
                                        When we receive your donation we separate it into individual components by
                                        spinning
                                        it in a machine called a centrifuge. The individual components are red cells,
                                        white
                                ...
                                <div className="landing-section-card">
                                    ...
                                    <div className="landing-section-card-description">
                                        To ensure the quality, safety, adequacy and cost effectiveness of the blood
                                        supply
                                        and related laboratory, clinical, academic and research services in accordance
                                        with
                        ...
                        <Row>
                            ...
                            <Col md={6}>
                                <div className="reserve-time-section-content">
                                    ...
                                    <div className={"link-btn-main mt-4"}>
                                        <Button href={"/reserve-time"} className={"link-btn"}>Reserve a
                                            time <ChevronRight
                                                color={"#C91A21"}
                                                className={"mb-1 chevron-right"}/></Button>
                                    </div>
