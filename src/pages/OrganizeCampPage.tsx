                        ...
                        <Col md={6}>
                            <div className={"organize-camp-content"}>
                                ...
                                <div className={"mt-4 organize-camp-description"}>
                                    ...
                                    blood
                                    donation events through an online platform. It streamlines the process of organizing
                                    and
                                    participating in blood donation events, making it easier to give the gift of life
                                    and
                                    save
